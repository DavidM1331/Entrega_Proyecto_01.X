...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Programa1Led_MGDavid.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/avr-main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/avr-main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/avr-main.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Programa1Led_MGDavid.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega16
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/avr-main.o: avr-main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Programa1Led_MGDavid.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "dist/${CND_CONF}/${IMAGE_TYPE}/Programa1Led_MGDavid.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/Programa1Led_MGDavid.X.${IMAGE_TYPE}.hex"
endif
